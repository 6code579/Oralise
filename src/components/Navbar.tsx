          ...
          <div>
            ...
            <ul className="flex flex-col gap-2 text-gray-600 dark:text-gray-300 text-sm sm:text-base">
              ...
              <li className="flex gap-3 mt-2">
                <a href="https://www.facebook.com/share/1CiA8gdtMP/"  target="_blank" aria-label="Facebook" className="hover:text-blue-600"><Facebook /></a>
                <a href="https://www.instagram.com/oralise.pro?igsh=MXJzaWZ6M3g4bHg3ZA==" aria-label="Instagram" className="hover:text-pink-500"><Instagram /></a>
